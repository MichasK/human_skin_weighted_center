...
#
# Generated by export_simulation on Mon May 06 07:28:19 +0100 2019
#
################################################################################
...
'-reset_run' switch to the './multi_deelay_0.sh' script.

./multi_deelay_0.sh -reset_run
...
./multi_deelay_0.sh -noclean_files

For more information on the script, please type './multi_deelay_0.sh -help'.
