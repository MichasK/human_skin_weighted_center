Real Time image processing application (1280x720 @60fps) running on Digilent ZYBO board for detection of weighted center of human body (in YCbCr color space).
